...
/**
 * WeatherWebServiceCallbackHandler Callback class, Users can extend this class and implement their
...
public abstract class WeatherWebServiceCallbackHandler {
  ...
  /**
   * auto generated Axis2 call back method for getSupportProvince method override this method for
   * handling normal response from getSupportProvince operation
   */
  public void receiveResultgetSupportProvince(
      top.imulan.webservice.weather.WeatherWebServiceStub.GetSupportProvinceResponse result) {}

  /**
   * auto generated Axis2 Error handler override this method for handling error response from
   * getSupportProvince operation
   */
  public void receiveErrorgetSupportProvince(java.lang.Exception e) {}

  /**
   * auto generated Axis2 call back method for getSupportCity method override this method for
   * handling normal response from getSupportCity operation
   */
  public void receiveResultgetSupportCity(
      top.imulan.webservice.weather.WeatherWebServiceStub.GetSupportCityResponse result) {}

  /**
   * auto generated Axis2 Error handler override this method for handling error response from
   * getSupportCity operation
   */
  public void receiveErrorgetSupportCity(java.lang.Exception e) {}

  /**
   * auto generated Axis2 call back method for getSupportDataSet method override this method for
   * handling normal response from getSupportDataSet operation
   */
  public void receiveResultgetSupportDataSet(
      top.imulan.webservice.weather.WeatherWebServiceStub.GetSupportDataSetResponse result) {}

  /**
   * auto generated Axis2 Error handler override this method for handling error response from
   * getSupportDataSet operation
   */
  public void receiveErrorgetSupportDataSet(java.lang.Exception e) {}

  /**
   * auto generated Axis2 call back method for getWeatherbyCityNamePro method override this method
   * for handling normal response from getWeatherbyCityNamePro operation
   */
  public void receiveResultgetWeatherbyCityNamePro(
      top.imulan.webservice.weather.WeatherWebServiceStub.GetWeatherbyCityNameProResponse result) {}
  ...
  /**
   * auto generated Axis2 call back method for getWeatherbyCityName method override this method for
   * handling normal response from getWeatherbyCityName operation
   */
  public void receiveResultgetWeatherbyCityName(
      top.imulan.webservice.weather.WeatherWebServiceStub.GetWeatherbyCityNameResponse result) {}
